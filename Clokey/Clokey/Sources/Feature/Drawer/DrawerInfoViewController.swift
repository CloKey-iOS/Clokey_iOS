...
//        // 상환이형 tagclothViewcontroller 참고
...
//        
//        // 만약 폴더 텍스트필드에 입력된 텍스트를 DrawerViewController에 전달하고 싶다면
//        // 예: drawerVC.title = drawerInfoView.folderTextField.text
//        
//        // 현재 DrawerInfoViewController가 네비게이션 컨트롤러 내에 있는 경우 push
...
//         
//         // numberLabel과 countLabel을 숨기도록 true 값 전달
...
class DrawerInfoViewController: UIViewController {
    ...
    @objc private func createButtonTapped() {
        ...
        // 예시: 폴더 텍스트필드의 텍스트를 DrawerViewController에 전달 가능
        // drawerVC.title = drawerInfoView.folderTextField.text
